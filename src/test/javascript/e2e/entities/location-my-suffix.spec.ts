...
describe('Location e2e test', () => {
    ...
    it('should load Locations', () => {
        ...
        expect(locationComponentsPage.getTitle()).toMatch(/jhipsterSampleApplicationApp.location.home.title/);
    ...
    it('should load create Location dialog', () => {
        ...
        expect(locationDialogPage.getModalTitle()).toMatch(/jhipsterSampleApplicationApp.location.home.createOrEditLabel/);
