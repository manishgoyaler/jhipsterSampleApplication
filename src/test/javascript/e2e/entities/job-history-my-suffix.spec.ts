...
describe('JobHistory e2e test', () => {
    ...
    it('should load JobHistories', () => {
        ...
        expect(jobHistoryComponentsPage.getTitle()).toMatch(/jhipsterSampleApplicationApp.jobHistory.home.title/);
    ...
    it('should load create JobHistory dialog', () => {
        ...
        expect(jobHistoryDialogPage.getModalTitle()).toMatch(/jhipsterSampleApplicationApp.jobHistory.home.createOrEditLabel/);
