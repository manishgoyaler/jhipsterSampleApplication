...
describe('Task e2e test', () => {
    ...
    it('should load Tasks', () => {
        ...
        expect(taskComponentsPage.getTitle()).toMatch(/jhipsterSampleApplicationApp.task.home.title/);
    ...
    it('should load create Task dialog', () => {
        ...
        expect(taskDialogPage.getModalTitle()).toMatch(/jhipsterSampleApplicationApp.task.home.createOrEditLabel/);
