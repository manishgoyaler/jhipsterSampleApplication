...
describe('Region e2e test', () => {
    ...
    it('should load Regions', () => {
        ...
        expect(regionComponentsPage.getTitle()).toMatch(/jhipsterSampleApplicationApp.region.home.title/);
    ...
    it('should load create Region dialog', () => {
        ...
        expect(regionDialogPage.getModalTitle()).toMatch(/jhipsterSampleApplicationApp.region.home.createOrEditLabel/);
