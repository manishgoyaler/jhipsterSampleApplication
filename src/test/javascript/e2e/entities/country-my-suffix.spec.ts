...
describe('Country e2e test', () => {
    ...
    it('should load Countries', () => {
        ...
        expect(countryComponentsPage.getTitle()).toMatch(/jhipsterSampleApplicationApp.country.home.title/);
    ...
    it('should load create Country dialog', () => {
        ...
        expect(countryDialogPage.getModalTitle()).toMatch(/jhipsterSampleApplicationApp.country.home.createOrEditLabel/);
