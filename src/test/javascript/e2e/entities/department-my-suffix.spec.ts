...
describe('Department e2e test', () => {
    ...
    it('should load Departments', () => {
        ...
        expect(departmentComponentsPage.getTitle()).toMatch(/jhipsterSampleApplicationApp.department.home.title/);
    ...
    it('should load create Department dialog', () => {
        ...
        expect(departmentDialogPage.getModalTitle()).toMatch(/jhipsterSampleApplicationApp.department.home.createOrEditLabel/);
